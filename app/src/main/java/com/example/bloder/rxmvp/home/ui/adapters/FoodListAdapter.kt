 ...
 */
class FoodListAdapter(val context: Context, val foods: MutableList<Food>) : RecyclerView.Adapter<FoodListAdapter.ViewHolder>() {
    ...
    class ViewHolder(val context: Context) : RecyclerView.ViewHolder(LayoutInflater.from(context).inflate(R.layout.view_holder_foods, null)) {
        fun bind(food: Food) {
